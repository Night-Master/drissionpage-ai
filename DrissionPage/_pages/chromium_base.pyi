...
from .._ai.agent import DrissionPageAgent
...
class ChromiumBase(BasePage):
    ...
    _type: str = ...
    _agent: Optional[DrissionPageAgent] = ...
    ...
    @property
    def agent(self) -> DrissionPageAgent:
        """返回 AI Agent 对象"""
        ...

    def aiAct(self, prompt: str, options: Optional[dict] = None) -> Any: ...

    def ai(self, prompt: str, options: Optional[dict] = None) -> Any: ...

    def aiTap(self, locate: str, options: Optional[dict] = None) -> Any: ...

    def aiHover(self, locate: str, options: Optional[dict] = None) -> Any: ...

    def aiInput(self, locate: str, opt: Optional[dict] = None, options: Optional[dict] = None) -> Any: ...

    def aiKeyboardPress(self, locate: Optional[str] = None, opt: Optional[dict] = None) -> Any: ...

    def aiScroll(self, locate: Optional[str] = None, opt: Optional[dict] = None) -> Any: ...

    def aiDoubleClick(self, locate: str, options: Optional[dict] = None) -> Any: ...

    def aiRightClick(self, locate: str, options: Optional[dict] = None) -> Any: ...

    def aiAsk(self, prompt: str, options: Optional[dict] = None) -> str: ...

    def aiQuery(self, data_demand: str, options: Optional[dict] = None) -> Any: ...

    def aiQueryImages(self, prompt: Any, options: Optional[dict] = None) -> Any: ...

    def aiBoolean(self, prompt: str, options: Optional[dict] = None) -> bool: ...

    def aiNumber(self, prompt: str, options: Optional[dict] = None) -> Union[int, float]: ...

    def aiString(self, prompt: str, options: Optional[dict] = None) -> str: ...

    def aiAssert(self, assertion: str, error_msg: Optional[str] = None, options: Optional[dict] = None) -> bool: ...

    def aiLocate(self, locate: str, options: Optional[dict] = None) -> Any: ...

    def aiWaitFor(self, assertion: str, options: Optional[dict] = None) -> bool: ...

    def runYaml(self, yaml_script_content: str) -> Any: ...

    def setAIActContext(self, ai_act_context: str) -> DrissionPageAgent: ...

    def evaluateJavaScript(self, script: str) -> Any: ...

    def recordToReport(self, title: Optional[str] = None, options: Optional[dict] = None) -> dict: ...

    def freezePageContext(self) -> dict: ...

    def unfreezePageContext(self) -> None: ...
